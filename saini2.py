...
class MyController(Manager.RyuApp):
	...
	def __init__(self, *args, **kwargs):
		...
		self.edge_port=ddict(dict)      #{switch_id{peer_id:weight}}
	...
	def _state_change_handler(self, ev):
    	...
    	def adj(self,g):				#From https://gist.github.com/Ceasar/2474603
    		vertices = g.keys()
    		dist = {}
    		for i in vertices:
        		dist[i] = {}
	...
	@handler.set_ev_cls(ofp_event.EventOFPPortStatus, handler.MAIN_DISPATCHER)
		...
		self._monitor()
			...
			self.destination=peer_id
				...
				print'After Edge_port delete, -->{switch_id:{peer_id:weight}}',self.edge_port #deleting the cureent down port 
                elif p.state==0:
			print 'Port Up'
	...
	def edge(self,src,dst):
		...
		print 'DATA STRUCTURE FOR  Directed Graph -->{switch_id:{peer_id:weight}} '#it has info about the neighbours switch id and respective weight added randomly .
...
#Reference  https://gist.github.com/Ceasar/2474603 and class notes from Mydrive 
